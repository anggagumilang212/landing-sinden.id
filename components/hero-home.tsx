          ...
          <div className="pb-12 text-center md:pb-20">
            ...
            <div className="mx-auto max-w-3xl">
              <p
                ...
                data-aos-delay={200}
              >
                Revolusi pengelolaan administrasi desa dengan dashboard modern yang mudah digunakan, komprehensif, dan mengintegrasikan semua kebutuhan manajemen desa dalam satu platform.
              </p>
