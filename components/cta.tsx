      ...
      <div className="max-w6xl mx-auto px-4 sm:px-6">
        <div className="bg-linear-to-r from-transparent via-gray-800/50 py-12 md:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-indigo-200/65 pb-5" data-aos="fade-up" data-aos-delay={200}>
              Bergabunglah dengan ratusan desa lainnya yang telah merasakan kemudahan mengelola administrasi dengan SINDEN
            </p>
